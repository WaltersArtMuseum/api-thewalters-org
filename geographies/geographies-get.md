...
```
GET v1/museum/geographies
```

The `GET v1/museum/geographies` request returns a distinct list of [geographic locations](/geographies/) that match your criteria according to the parameters below. 
